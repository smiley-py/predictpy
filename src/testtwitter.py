...
class CustomTwitter:
    def run(self):
        ...
        length_train = train['tweet'].str.len().plot.hist(
            color='pink', figsize=(6, 4))
        length_test = test['tweet'].str.len().plot.hist(
            color='orange', figsize=(6, 4))
        ...
        normal_words = ' '.join(
            [text for text in train['tweet'][train['label'] == 0]])
        ...
        negative_words = ' '.join(
            [text for text in train['tweet'][train['label'] == 1]])
        ...
        tqdm_pandas(tqdm(desc="progress-bar"))
